...
\chapter{Experimentation and Testing}
  ...
  \label{sec:precision}
  To test how precise / reliable it is. 

    \subsection{Testing Strategy} % (fold)
    \label{sub:testing_strategy}
      I will run nine tests and record the expected rate of return for the solution the algorithm gives. Each of the nine tests will be run 20 times with a mean and standard deviation calculated and shown in the following sections. The nine tests will be as follows:
        \begin{itemize}
    ...
    \label{sub:hypothesis}
      My hypothesis is that the application is reliable and that the results (for the same input) will have almost the same output, ie it is reliable and precise. 
    % subsection hypothesis (end)

    \subsection{Results} % (fold)
    \label{sub:results}
    Expected return for all tests
    Means:
  ...
  This test might seem a little peculiar at first but be  assure, there is method in this madness, that's what I tell myself anyways... I want to see what the relationship is (if any) between the time it takes to run, number of particles, number of iterations and number of assets.
    ...
    \label{sub:results}
        ...
        \begin{table}[H]
          ...
          \begin{tabular}{|l|l|l|}
            ...
            Test & Mean Result & Standard deviation \\
            \hline
            Test 1 & 1 & $1.3735\times10^{9}$ \\
            \hline
            Test 2 & 1 & $1.5589\times10^{11}$ \\
            \hline
            Test 3 & 1 & $1.6068\times10^{11}$ \\
            \hline
            Test 4 & 1 & $6.4372\times10^{9}$ \\
            \hline
            Test 5 & 1 & $2.66467\times10^{15}$ \\
            \hline
            Test 6 & 1 & $1.29662\times10^{11}$ \\
            \hline
            Test 7 & 1 & $2.027735\times10^{11}$ \\
            \hline
            Test 8 & 1 & $2.28702\times10^{10}$ \\
            \hline
            Test 9 & 1 & $2.54305\times10^{11}$ \\
            \hline
          \end{tabular}
    ...
    Results mean 1.
    Results standard deviation $2.66467*10^-15, 1.29662*10^-11, 0.027735, 2.28702*10^-11, 2.54305*10^-10$
